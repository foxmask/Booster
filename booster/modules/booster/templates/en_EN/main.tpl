...
<div id="footer">
    <div class="top-container">
        ...
        <div class="footer-box">
             <p>
                <span style="color:red">BETA version</span> - <a href="https://github.com/foxmask/Booster/issues/new">An issue ? let us know </a> - <a href="{jurl 'booster~default:credits'}">Crédits</a>
            </p>
        </div>
